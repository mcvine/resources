...
<inventory>
    ...
    <component name="arcs_moderator2sample">
        ...
        <component name="analytic_mod">
            <property name="xwidth">0.1</property>
            <property name="yheight">0.12</property>
            <property name="dist">2.5</property>
            <property name="focus_xw">0.1</property>
            <property name="focus_yh">0.12</property>
            <property name="Emin">620</property>
            <property name="Emax">740</property>
            <property name="tinmin">0</property>
            <property name="tinmax">20</property>
            <property name="filename">/SNS/users/linjiao/simulations/moderator/a1Gw2-17-f5_fit_fit.dat</property>
	    <property name="proton_T">0.695</property>
	    <property name="sample_E">1</property>
	    <property name="sample_t">0</property>
            <property name="name">sns_source_analytic</property>
        </component>
<!--      <property name="angling">-13.75</property> -->
        ...
        <component name="t0chopper">
            ...
            <property name="tc">0.000768989899615</property>
        ...
        <component name="fermichopper">
            <property name="phase">-219.624975902</property>
            <property name="radius">0.07</property>
            <property name="nu">600.0</property>
            <property name="ymin">-0.0325</property>
            <property name="ymax">0.0325</property>
            <property name="w">0.000508</property>
            <property name="Nslit">124</property>
            <property name="m">0</property>
            <property name="length">0.1</property>
            <property name="eff">.95</property>
            <property name="curvature">0.6647610184138802</property>
            <property name="name">fermichopper</property>
        </component>
